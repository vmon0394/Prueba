 ...
 */
$aColumns = array('idSeguimientoExterno', 'fechaSeguimientoSesion', 'observaciones');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idSeguimientoExterno";

/* DB table to use */
$sTable = "tbl_seguimiento_sesion_externos";
...
$sWhere = " WHERE isdelSeguimientoExterno = '1' AND idHistoriaExterno = '$idHistoria' ";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idSeguimientoExterno") {
            $ID = $aRow[$aColumns[$i]];
            $row[] = "<center>" . $conta . "</center>";
        } else if ($aColumns[$i] == "observaciones") {
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='40%' height='40%' title='Eliminar Archivo'/></a></center>";

 ...
 */
$aColumns = array('idHistoria', 'fechaIngreso', 'documento', 'nombres', 'apellidos', 'nombreSemillero', 'beneficiario', 'estadoProceso', 'nombresEmp', 'apellidosEmp');
$sJoin = " INNER JOIN tbl_ficha_sociofamiliar ON tbl_ficha_sociofamiliar.idFicha = tbl_historia_clinica.idFicha "
        . " INNER JOIN tbl_semilleros ON tbl_semilleros.idSemillero = tbl_ficha_sociofamiliar.idSemillero "
        . " INNER JOIN tbl_personal_empleados ON tbl_personal_empleados.idEmpleado = tbl_historia_clinica.idPsicologa ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idHistoria";

/* DB table to use */
$sTable = "tbl_historia_clinica";
...
$sWhere = " WHERE tbl_historia_clinica.tipoRegistroHis = 'Consultoría' ";

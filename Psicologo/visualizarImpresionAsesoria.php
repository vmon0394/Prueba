...
$idAsesoria = 0;
if (isset($_GET['asesoria'])) {
    $idAsesoria = $_GET['asesoria'] != 0 ? $_GET['asesoria'] : 0;
}
?>
<!DOCTYPE html>
<html>
    ...
    <body>
                    ...
                    <div class="tab-content"> 
                        ...
                        <form  method="POST" id="frmAsesoriaParticipante">     
                            ...
                            <div class="tab-pane">
                                ...
                                <div id="datosBeneficiario" style="display: block;">
                                ...
                                <table
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="motivo" class="text_justificado"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="antecedentes" class="text_justificado"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <br><h3><center>IV. FOCOS O CONFLICTOS NODALES</center></h3><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="conflictos" class="text_justificado"></div>
                                            </div> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <br><h3><center>V. METAS TERAPÉUTICAS</center></h3><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="metas" class="text_justificado"></div>
                                            </div> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <br><h3><center>VI. LOGROS</center></h3><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="logros" class="text_justificado"></div>
                                            </div> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <br><h3><center>VII. PRUEBAS APLICADAS (Interpretación):</center></h3><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="pruebas" class="text_justificado"></div>
                                            </div>   
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                                <div id="motivoRemisione" class="text_justificado"></div>
                                            </div>      
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <script>
            imprimirAsesoria(<?php echo "'$idAsesoria'" ?>);
        </script>

 ...
 */
$aColumns = array('idTaller', 'tipoTaller','nombreTaller','fechaTaller','fechaLimite','isdelTaller');
//$sJoin = " INNER JOIN tbl_semilleros ON tbl_semilleros.idSemillero = tbl_dofa.idSemillero";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idTaller";
...
$sWhere = " WHERE isdelTaller = '1' AND idSemillero = '$idSemillero' AND fechaTaller BETWEEN '2016-01-01' AND '2017-12-31'  ";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        } else if ($aColumns[$i] == "isdelTaller") {
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='assistance' target='_blank'><img src='../img/asistencia.png' class='img-responsive img-rounded' width='35%' height='35%' title='Asistencia del Taller'/></a></center>";
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='30%' height='30%' title='Consultar Taller'/></a></center>";

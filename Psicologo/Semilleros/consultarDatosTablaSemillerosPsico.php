 ...
 */
$aColumns = array('idSemillero', 'nombreSemillero', 'nombreCategoria', 'isdelSemillero');
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='verTalleres' target='_blank'><img src='../img/talleres.png' class='img-responsive img-rounded' width='25%' height='25%' title='Consultar Talleres Psicosociales del Semillero'/></a></center>";

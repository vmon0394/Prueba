                        ...
                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="padding-right: 10px; color: #000; width:90px">Ingreso</th>
                                    <th class="text-center" style="padding-right: 10px; color: #000; width:90px">Permanencia</th>

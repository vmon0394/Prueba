 ...
 */
$aColumns = array('idDocumentos', 'tipoDocumento', 'nombreDocumento', 'fecha', 'url');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idDocumentos";

/* DB table to use */
$sTable = "tbl_documentos";

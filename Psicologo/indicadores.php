                            ...
                            <div class="tab-pane">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="textinput">Indicador *</label>
                                            <div class="controls input-group">
                                                <input id="indicador"  name="indicador" type="text" placeholder="Ingrese el Nombre del Indicador" class="input-xxlarge">
                                            </div>
                                        </div>
                                    </div>
                                </div>

...
//    $row[] = $conta; //Nº
    ...
    if ($estado == "0") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='enable' target='_blank'><img src='../img/chulo.png' class='img-responsive img-rounded' width='35%' height='35%' title='Eliminar Indicador'/></a></center>";
    } 
//    else if ($estado == "0") {

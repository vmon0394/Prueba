                    ...
                    <div class="tab-content"> 
                        ...
                        <div id="historialParticipante" style="display: none;">
                            ...
                            <div id="divLimpiarAsesoria" style="display: none;">
                                ...
                                <center>
                                    <div class="control-group">
                                        <button type="button" class="btn btn-warning" id="clearAsesoria" data-dismiss="modal">Volver</button> &nbsp;&nbsp;
                        ...
                        <div id="consultoriaParticipante" style="display: none;">
                            ...
                            <div id="divLimpiarConsultoria" style="display: none;">
                                ...
                                <center>
                                    <div class="control-group">
                                        <button type="button" class="btn btn-warning" id="clearConsultoria" data-dismiss="modal">Volver</button> &nbsp;&nbsp;

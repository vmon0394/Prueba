...
//    function getCellCacheController()
     ...
     */
    public function setCellValueA($pCoordinate = 'A1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueB($pCoordinate = 'B1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueC($pCoordinate = 'C1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueD($pCoordinate = 'D1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueE($pCoordinate = 'E1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueF($pCoordinate = 'F1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueG($pCoordinate = 'G1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueH($pCoordinate = 'H1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueI($pCoordinate = 'I1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueJ($pCoordinate = 'J1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueK($pCoordinate = 'K1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueL($pCoordinate = 'L1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueM($pCoordinate = 'M1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueN($pCoordinate = 'N1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueO($pCoordinate = 'O1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueP($pCoordinate = 'P1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueQ($pCoordinate = 'Q1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueR($pCoordinate = 'R1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueS($pCoordinate = 'S1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueT($pCoordinate = 'T1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueU($pCoordinate = 'U1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueV($pCoordinate = 'V1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueW($pCoordinate = 'W1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueX($pCoordinate = 'X1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueY($pCoordinate = 'Y1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

    public function setCellValueZ($pCoordinate = 'Z1', $pValue = null, $returnCell = false) {
        $cell = $this->getCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }

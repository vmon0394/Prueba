...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Reportes actividades</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <br>
                        <?php include_once '../Formularios/frmReportePrestamos.php'; ?>
        ...
        <script src="../js/funcionesReportePrestamos.js" type="text/javascript"></script>

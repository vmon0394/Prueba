        ...
        <div class="container-fluid">
            ...
            <div class="menu nav-collapse">
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            ...
                            <li class="divider"></li>
                            <li><a href="consultaMaterialZona.php"><i class="icon-folder-open icon-white"></i> Materiales Zona</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                ...
                <ul class="nav pull-right">
                    <a href="semilleros.php" class="btn btn-small" role="button" aria-expanded="false"><i class="icon-arrow-left icon-black"></i> Perfil principal</a> 
                </ul>

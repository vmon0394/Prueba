        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Campamentos</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <div class="control-group">                                
                            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Listado de Campamentos &nbsp;&nbsp;</button>
                            <!-- tabs left -->
                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                ...
                                <div class="tabbable tabs-left">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#a" data-toggle="tab" class="">Campamentos</a></li>
                                        <li><a href="#b" data-toggle="tab" class="">Campamentos Eliminados</a></li>
                                    </ul>
                                        ...
                                        <div class="tab-pane active" id="a">
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    $sql = "SELECT COUNT(*) as contarsalidas FROM tbl_salidas WHERE isdelSalida = 1 AND fechaSalida BETWEEN '2016-01-01' AND '2017-12-31'";
                                                    $rs = $conexion->query($sql);
                                                        if ($numero = $rs->fetch_assoc()){
                                                        echo  "<h4>Campamentos Existentes: ".$numero['contarsalidas']."</h4>";
                                                        }else{
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    $sql = "SELECT SUM(numParticipantes) as contarparticisali FROM tbl_salidas WHERE isdelSalida = 1 AND fechaSalida BETWEEN '2016-01-01' AND '2017-12-31'";
                                                    $rs = $conexion->query($sql);
                                                        if ($numero = $rs->fetch_assoc()){
                                                ...
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:200px">Nombre Campamento</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:60px">Fecha Campamento</th>
                                        ...
                                        <div class="tab-pane" id="b">
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    $sql = "SELECT COUNT(*) as contarsalidas FROM tbl_salidas WHERE isdelSalida = 0 AND fechaSalida BETWEEN '2016-01-01' AND '2017-12-31'";
                                                    $rs = $conexion->query($sql);
                                                        if ($numero = $rs->fetch_assoc()){
                                                        echo  "<h4>Campamentos Existentes: ".$numero['contarsalidas']."</h4>";
                                                        }else{
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    $sql = "SELECT SUM(numParticipantes) as contarparticisali FROM tbl_salidas WHERE isdelSalida = 0 AND fechaSalida BETWEEN '2016-01-01' AND '2017-12-31'";
                                                    $rs = $conexion->query($sql);
                                                        if ($numero = $rs->fetch_assoc()){
                                                        echo  "<h4>Total de Participantes: ".$numero['contarparticisali']."</h4>";
                                                        }else{

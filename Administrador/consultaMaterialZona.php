...
<html>
    ...
    <body>
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Materiales por Zona</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <div id="consultaZona" style="display: none;">
                            <br>
                            <div id="" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                <div class="table-responsive">                            
                                    <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="padding-right: 10px; color: #000; width:20px">NÂ°</th>                                 
                                                <th class="text-center" style="padding-right: 10px; color: #000; width:600px">Material</th>
						                        <th class="text-center" style="padding-right: 10px; color: #000; width:600px">Codigo</th>
                                            </tr>
                                        </thead>
                                        <tbody  id="index_ajax">
        ...
        <script src="../js/funcionesConsultaZonas.js" type="text/javascript"></script>

            ...
            <div class="row-fluid">    
                <div class="breadcrumb">
                    <div class="tab-content">   
                        ...
                        <?php  //include_once '../Formularios/frmServicios.php'; ?> 
                            <div class="tab-pane">
                            ...
                            <br>
                            <center>
                                <button type="submit" class="btn btn-primary" name="acc" value="j">Guardar</button>
                            </center>  
                        </form>
                                            ...
                                            foreach ($servicio as $numero) {
                                                    echo" 
                                                        <tr>
                                                            ...
                                                            <td><center><a href='../Formularios/ModificarServicio.php?ui=".base64_encode($numero["idServicio"])."'><img src='../img/chulo.png' border= '0' height='20' width='30'/></a></center></td>
                                                            <td><center><a href='../Controller/ctrlServiciosModificados.php?ui=".base64_encode($numero["idServicio"])."&acc=e'><img src='../img/dele.png' border= '0' height='20' width='40'/></a></center></td>
                                                        </tr>";
                                                    }
                                        ?>
                                        </tbody>

 ...
 */
$aColumns = array('id_testimonio', 'fechaTaller', 'nombreTaller', 'testimonio');
$sJoin = " INNER JOIN tbl_semilleros ON tbl_semilleros.idSemillero = tbl_testimonios_semilleros.idSemillero ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "id_testimonio";

/* DB table to use */
$sTable = "tbl_testimonios_semilleros";
...
$sWhere = " WHERE tbl_testimonios_semilleros.idSemillero = '$idSemillero' AND tbl_testimonios_semilleros.anoTestimonio = '$fechaSistema' ";
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='35%' height='35%' title='Asistencia del Taller'/></a></center>";

...
$sWhere = " WHERE isdelSalida = '0' AND fechaSalida BETWEEN '2017-01-01' AND '2017-12-31'";
...
//    $row[] = $conta; //Nº
    ...
    if ($estado == "0") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='enable' target='_blank'><img src='../img/chulo.png' class='img-responsive img-rounded' width='40%' height='40%' title='Eliminar Salida'/></a></center>";
    } 
     else if ($estado == "0") {

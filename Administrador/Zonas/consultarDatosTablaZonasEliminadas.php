...
//    $row[] = $conta; //Nº
    ...
    if ($estado == "0") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='enable' target='_blank'><img src='../img/chulo.png' class='img-responsive img-rounded' width='40%' height='40%' title='Habilitar Zona'/></a></center>";
    }
//    else if ($estado == "0") {

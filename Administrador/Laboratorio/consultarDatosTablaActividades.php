...
$aColumns = array('idActividad', 'nombreServicio','nombreActividad', 'fecha', 'estado','asistenciaActividad', 'isdelActividad');
$sJoin = " INNER JOIN tbl_servicios ON tbl_servicios.idServicio = tbl_actividades_laboratorio.idServicio";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idActividad";

/* DB table to use */
$sTable = "tbl_actividades_laboratorio";

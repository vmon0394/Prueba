 ...
 */
$aColumns = array('idPrestamo', 'documento', 'codigo', 'fechaPrestamo', 'fechaEntrega');
//$sJoin = " INNER JOIN tbl_inventario ON tbl_inventario.idMaterial = tbl_prestamo_devolucion.idMaterial ";

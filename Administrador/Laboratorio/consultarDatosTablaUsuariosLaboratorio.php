 ...
 */
$aColumns = array('idUsuario', 'nombre', 'apellido', 'edad','documento', 'acudiente', 'isdelUsuario');
...
/* DB table to use */
$sTable = "tbl_usuario_laboratorio";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        } else if ($aColumns[$i] == "isdelUsuario") {

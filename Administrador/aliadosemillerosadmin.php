...
if (!isset($_SESSION["usuario"]) || $_SESSION["perfil"] != "Administrador") {
 ...
 $semillero2 = new libSemilleros();
 $semillero2->aliadoseleccionado();

 $semillero2 = (base64_decode($_REQUEST["ui"]));
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Consultar Semilleros Por Aliado</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        <label class="alert alert-info">Semilleros por Aliado Registrado</label>


                        <center>
                            <div class="control-group">
                                <a href="consultaraliadosadmi.php"><button type="button" class="btn btn-primary" data-dismiss="modal">Volver</button></a>
                        </center>       
                            <br>
        <!--constructor-->
                         <?php
                                ...
                                $conexion =$link->conectar();
                                    ...
                                    $resp = FALSE;
                                        ...
                                        $sql = "SELECT COUNT(*) as contarsemilleros FROM tbl_semilleros WHERE aliado1 = '".$semillero2."'";
                            ...
                            <?php
                             include_once '../Model/conexion.php';
                                ...
                                if (!$conexion) {
                                    ...
                                    $sql = "SELECT tbl_semilleros.NombreSemillero,tbl_semilleros.comuna,
                                    ...
                                    FROM tbl_semilleros  WHERE aliado1 = '".$semillero2."'";
                                    $rs = $conexion->query($sql);

 ...
 */
$aColumns = array('idFicha', 'documento', 'nombres', 'apellidos', 'sexo', 'anosDePermanencia', 'isdel');
...
$sWhere = " WHERE isdel = '0' AND idSemillero = '$idSemillero' ";
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='historySemi' target='_blank'><img src='../img/historial_semilleros.png' class='img-responsive img-rounded' width='30%' height='30%' title='Ver Historial de Semilleros del Participante'/></a></center>";
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='enable' target='_blank'><img src='../img/chulo.png' class='img-responsive img-rounded' width='30%' height='30%' title='Habilitar Ficha Socio Familiar'/></a></center>";

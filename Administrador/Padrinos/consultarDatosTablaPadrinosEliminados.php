 ...
 */
$aColumns = array('id_Padrino', 'documento_padrino', 'nombres_padrino', 'apellidos_padrino', 'fecha_autorizacion', 'isdel_padrino');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "id_Padrino";
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='35%' height='35%' title='Consultar Padrino'/></a></center>";
    if ($estado == "0") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='enable' target='_blank'><img src='../img/chulo.png' class='img-responsive img-rounded' width='35%' height='35%' title='Habilitar Padrino'/></a></center>";
    } 

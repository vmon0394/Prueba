                ...
                <div class="breadcrumb">
                    ...
                    <div class="tab-content"> 
                        ...
                        <div id="historialParticipante" style="display: none;">
                            ...
                            <?php include_once 'frmAsesoriaParticipante.php'; ?>
                        ...
                        <div id="consultoriaParticipante" style="display: none;">
                            ...
                            <?php include_once 'frmConsultoriaParticipante.php'; ?>
                            ...
                            <div id="divLimpiarConsultoria" style="display: none;">
                                ...
                                <center>
                                    <div class="control-group">
                                        <button type="button" class="btn btn-primary" id="clearConsultoria" data-dismiss="modal">Limpiar</button>
                                    </div>
                                </center>

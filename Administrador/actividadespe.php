...
<html>
    <head>
        ...
        <title>FundaciÃ³n | Administrador</title>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Actividades Especiales</h1>
                </div>
            </div>
            <br>
            <br>
                            ...
                            <table class="table table-striped table-hover table-bordered table-condensed" id="">
                                <thead>
                                    <tr>
                                        ...
                                        <th  style="padding-right: 10px; color: #000; width:480px; text-align:center;">Actividad Especial</th>

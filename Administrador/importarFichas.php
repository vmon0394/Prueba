                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <p style="text-align: justify;">                          
                                            ...
                                            <br><br>
                                            2.	Antes de importar realice los siguientes pasos para eliminar las formulas que contenga este archivo y cerciorarse que la información se importe correctamente.
                                            <br><br>
                                            -   Verifique que el archivo de Excel solo tenga una única hoja con la información que desea importar.
                                            <br>
                                            -	Seleccione toda la información de las fichas desde la columna B1 hasta la última columna y la última fila, esto también se puede realizar dando clic en B1 y luego presionando a la vez control + shift y  dejando estas dos teclas presionadas le da clic a la tecla izquierda y luego abajo dos veces.
                                            <br>

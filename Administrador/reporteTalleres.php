            ...
            <div class="row-fluid">
                <div class="logobar">
                    <div class="logo pull-left">
                        <a href="#" title="Sistema de GestiÛn | FundaciÛn Conconcreto"><img src="../img/fundacion_logo.png" style="width: 290px;"></a>          
                    </div>
                    <br>
                    ...
                    <div class="tab-content"> 
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-hover table-bordered table-condensed" id="">
                                <thead>
                                    <tr>
 					                    <th class="text-center" style="padding-right: 10px; color: #000; width:40px; text-align:center;">N∫</th>

                ...
                <ul class="nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            ...
                            <li><a href="servicios.php"><i class="icon-folder-open icon-white"></i> Servicios</a></li>
                            <li><a href="consultaUsuariosServicios.php"><i class="icon-folder-open icon-white"></i>Participantes por Servicio</a></li>
                            <!--<li><a href="institucionsemillero.php"><i class="icon-folder-open icon-white"></i> Institucion y semillero</a></li>
                            <li><a href="ActividadesComunitarias.php"><i class="icon-folder-open icon-white"></i>Actividades Comunitarias</a></li>-->
                            <li class="divider"></li>
                            <li><a href="valoresLaboratorio.php"><i class="icon-folder-open icon-white"></i> Valores</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            <li><a href="inventario.php"><i class="icon-folder-open icon-white"></i> Inventario</a></li>
                            <li><a href="zonas2.php"><i class="icon-folder-open icon-white"></i> Zonas</a></li>
                            <li class="divider"></li>
                            <li><a href="consultaMaterialZona.php"><i class="icon-folder-open icon-white"></i>Material Zona</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            <li><a href="prestamoDevolucion.php"><i class="icon-folder-open icon-white"></i> Préstamos </a></li>

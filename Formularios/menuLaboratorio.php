                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            ...
                            <li><a href="../Administrador/historialPrestamo.php"><i class="icon-folder-open icon-white"></i> Historial </a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            <li><a href="../Administrador/actividadesLaboratorio.php"><i class="icon-folder-open icon-white"></i> Actividades laboratorio</a></li>
                            <li><a href="../Administrador/evidenciasActividades.php"><i class="icon-folder-open icon-white"></i> Evidencia actividades</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu"> 
                            <li><a href="../Administrador/reportePrestamos.php"><i class="icon-folder-open icon-white"></i> Reporte general</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
                </ul>
                <ul class="nav pull-right">
                    <a href="../Administrador/usuarios.php" class="btn btn-small" role="button" aria-expanded="false"><i class="icon-arrow-left icon-black"></i> Perfil principal</a> 
                </ul>

            ...
            <div class="twoColumns">
                ...
                <div class="control-group">
                    ...
                    <div class="controls input-group">
                        <select id="semilleroAdulto"  name="semilleroAdulto" class="input-large">
                            <?php
        ...
        <div id="Apaso2" class="tab-pane" style="display: none;">
            ...
            <div class="twoColumns">
                ...
                <div class="control-group">
                    ...
                    <div class="controls input-group">                        
                        <select id="nivelEscolaridad"  name="nivelEscolaridad" class="input-xlarge">
        ...
        <div id="Apaso3" class="tab-pane" style="display: none;">
            ...
            <div class="twoColumns">
                ...
                <div class="control-group">
                    ...
                    <div class="controls input-group">
                        <select id="registroAdulto"  name="registroAdulto" class="input-large">
                            <option value="0">SELECCIONE UNA OPCIÓN</option>
                            <option value="SI">SI</option>
                            <option value="NO">NO</option>
                        </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls input-group">                        
                        <select id="observacionDiscapaAdulto"  name="observacionDiscapaAdulto" class="input-large">
                            <option value="0">SELECCIONE UN TIPO</option>
        ...
        <div id="demoA" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#lA" data-toggle="tab" class="">Foto de Perfí</a></li> 
...
<div id="Apaso5" class="tab-pane active" style="display: none">
    ...
    <form  method="POST" class="form-horizontal" id="frmObservacionAdulto">     
        <div class="tab-pane">
            ...
            <input id="tipoObservaionAdulto"  name="tipoObservaionAdulto" type="hidden" value="<?php echo $_SESSION["perfil"]; ?>">

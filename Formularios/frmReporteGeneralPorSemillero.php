                ...
                <div class="controls">
                    <div class="control-group">
                        ...
                        <div class="controls input-group">
                            <select id="semillero"  name="semillero[]" class="input-xlarge" multiple="multiple">
                                <?php
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button" id="consult" name="consultar"><i class="icon-search"></i></button>
                            </span>
                        </div>
                    </div>
                </div>

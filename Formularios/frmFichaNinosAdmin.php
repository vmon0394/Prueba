            ...
            <div class="twoColumns">
                ...
                <div class="control-group">
                    ...
                    <div class="controls input-group">
                        <select id="semilleroN"  name="semilleroN" class="input-large">
                            <?php
        ...
        <div id="demoN" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#bN" data-toggle="tab" class="">Foto seguimiento</a></li>
                    <li><a href="#fP" data-toggle="tab" class="">Foto perfíl</a></li>
                    ...
                    <div class="tab-pane" id="fP" name="fP">
                        ...
                        <form id="formUploadFotoPerfil" class="form-horizontal"  method="post" id="usrform0" enctype="multipart/form-data">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="controls">
                                        <input name="archivoFotoPerfil" id="archivoFotoPerfil" type="file" size="400" />
                                    </div>
                                </div>
                            </div>
...
<div id="paso6" class="tab-pane active" style="display: none">
    ...
    <form  method="POST" class="form-horizontal" id="frmObservacionNino">     
        <div class="tab-pane">
            ...
            <input id="tipoObservaion"  name="tipoObservaion" type="hidden" value="<?php echo $_SESSION["perfil"]; ?>">

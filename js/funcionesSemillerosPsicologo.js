$(document).ready(function () {
    ...
    $('#tblRol').on('click', 'a.verTalleres', function () {
        ...
        $("#tituloTaller").html("TALLERES PSICOSOCIALES " + td[1].innerText);
    ...
    $('#returnTalleresSemi').click(function () {
        ...
        $("#horaInicioTaller").removeAttr("disabled");
        $("#horaFinTaller").removeAttr("disabled");
        ...
        $("#ejeTaller").removeAttr("disabled");
        $("#temaTaller").removeAttr("disabled");
        ...
        $("#horaInicioTaller").css({"border": "", "box-shadow": ""});
        $("#horaFinTaller").css({"border": "", "box-shadow": ""});
        ...
        $("#ejeTaller").css({"border": "", "box-shadow": ""});
        $("#temaTaller").css({"border": "", "box-shadow": ""});
        $("#objetivoTaller").css({"border": "", "box-shadow": ""});
        $("#tiempoTaller").css({"border": "", "box-shadow": ""});
        $("#descripcionTaller").css({"border": "", "box-shadow": ""});
        $("#logrosTaller").css({"border": "", "box-shadow": ""});
        $("#dificultadesTaller").css({"border": "", "box-shadow": ""});
        $("#recomendacionesTaller").css({"border": "", "box-shadow": ""});
...
function validarAsistenciaTalleres() {
    ...
    $.ajax({
        type: "POST",
        url: "../Controller/ctrlFichaSocioFamiliar.php?opcion=13",
        error: function (jqXHR, textStatus, errorThrown) {
            //*Ocurrió un eror en la petición ajax
            $("#LoadingImage").hide();
            console.log(textStatus + "\n" + errorThrown);
...
function tabla() {
    ...
    $('#tblRol').dataTable({
        ...
        "bPaginate": true,
        "iDisplayLength": 10,
        "sAjaxSource": "Semilleros/consultarDatosTablaSemillerosPsico.php",
        "order": [[1, "asc"]],
        "aoColumnDefs": [{
                "aTargets": [2],
                "sType": "html"
...
function tabla2(idSemillero) {
    ...
    $('#tblRol2').dataTable({
        ...
        "bPaginate": true,
        "iDisplayLength": 10,
        "sAjaxSource": "Fichas/consultarDatosTablaFichasPsico.php?semillero=" + encodeURIComponent(idSemillero),
        "order": [[3, "asc"]],
        "aoColumnDefs": [{
                "aTargets": [2],
                "sType": "html"
...
function tabla3(idSemillero) {
    ...
    $('#tblRol3').dataTable({
        ...
        "bPaginate": true,
        "iDisplayLength": 10,
        "sAjaxSource": "Fichas/consultarDatosTablaFichasEliminadasPsico.php?semillero=" + encodeURIComponent(idSemillero),
        "order": [[3, "asc"]],
        "aoColumnDefs": [{
                "aTargets": [2],
                "sType": "html"

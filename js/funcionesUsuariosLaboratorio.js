$(document).ready(function () {
    ...
    // sirve para esconder los campos mientras no se seleccione una opcion diferente a 0
            $("#a").hide();
            $("#b").hide();
            $("#c").hide();
            $("#ed").hide();
    ...
    $("#tipoRegistro").change(function (e) {
        ...
        if ($("#tipoRegistro").val() === "0") {
        ...
        }else if ($("#tipoRegistro").val() === "instituto") {
        ...
        }else if ($("#tipoRegistro").val()==="semillero"){
            ...
            $("#acude").removeAttr("disabled").show();
    ...
    $('#save').click(function () {
        ...
        if ($("#tipoRegistro").val() === "0") {
            ...
            $.ajax({
                type: "POST",
                url: "../Controller/ctrlUsuariosLaboratorio.php?opcion=1",

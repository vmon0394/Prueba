$(document).ready(function () {
    ...
    $('#save').click(function () {
        ...
        if ($('#categoria').val() == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "../Controller/ctrlCategorias.php?opcion=1",
    ...
    $('#tblRol').on('click', 'a.consult', function () {
        ...
        $.ajax({
            type: "POST",
            url: "../Controller/ctrlCategorias.php?opcion=2",
            data: {idCategoria: id},
            error: function (jqXHR, textStatus, errorThrown) {
            ...
            success: function (result) {
                ...
                if (data.res === 'fail') {
                    ...
                    $("#idCategoria").val(data.row.IdCategoria);
                    $("#categoria").val(data.row.NombreCategoria);
    ...
    $('#update').click(function () {
        ...
        if ($('#categoria').val() == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "../Controller/ctrlCategorias.php?opcion=3",
                data: $("#frmCategorias").serialize(),
                error: function (jqXHR, textStatus, errorThrown) {
                    console.log(textStatus + "\n" + errorThrown);
                },
    ...
    $('#tblRol').on('click', 'a.delete', function () {
        ...
        $.ajax({
            type: "POST",
            url: "../Controller/ctrlCategorias.php?opcion=4",
            data: {idCategoria: id},
            error: function (jqXHR, textStatus, errorThrown) {
                //*Ocurrió un eror en la petición ajax
                $("#LoadingImage").hide();
    ...
    $('#tblRol2').on('click', 'a.enable', function () {
        ...
        $.ajax({
            type: "POST",
            url: "../Controller/ctrlCategorias.php?opcion=5",
            data: {idCategoria: id},
            error: function (jqXHR, textStatus, errorThrown) {
                //*Ocurrió un eror en la petición ajax
                $("#LoadingImage").hide();
...
function tabla() {
    ...
    $('#tblRol').dataTable({
        ...
        "bPaginate": true,
        "iDisplayLength": 10,
        "sAjaxSource": "Categorias/consultarDatosTablaCategorias.php",
        "order": [[1, "asc"]],
        "aoColumnDefs": [{
                "aTargets": [2],
                "sType": "html"
...
function tabla2() {
    ...
    $('#tblRol2').dataTable({
        ...
        "bPaginate": true,
        "iDisplayLength": 10,
        "sAjaxSource": "Categorias/consultarDatosTablaCategoriasEliminados.php",
        "order": [[1, "asc"]],
        "aoColumnDefs": [{
                "aTargets": [2],
                "sType": "html"

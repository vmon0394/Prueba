<?php
session_start();
if (!isset($_SESSION["usuario"]) || $_SESSION["perfil"] != "Ajedrez") {
            ...
            <div class="row-fluid">    
                <div class="breadcrumb">
                    <div class="tab-content">   
                        <?php                                            
                        include_once '../Formularios/frmServicios.php';
                        ?>
                                    ...
                                    <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="padding-right: 10px; color: #000; width:500px">Nombre Servicio</th>
                                                <th class="text-center" style="padding-right: 10px; color: #000; width:40px">Ver PDF</th>
                                                <th class="text-center" style="padding-right: 10px; color: #000; width:30px">Consultar</th>
                                                <th class="text-center" style="padding-right: 10px; color: #000; width:30px">Eliminar</th>
                                            </tr>
                                        </thead>
                                        <tbody  id="index_ajax">

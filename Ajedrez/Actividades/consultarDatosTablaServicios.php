 ...
 */
$aColumns = array('idServicio', 'nombreServicio', 'url', 'isdelServicio');
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='../$url' title='' data-toggle='modal' class='see' target='_blank'><img src='../img/ojo.png' class='img-responsive img-rounded' width='60%' height='60%' title='Ver Técnica'/></a></center>";
    
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='35%' height='35%' title='Consultar Material'/></a></center>";
    if ($estado == "1") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='delete' target='_blank'><img src='../img/dele.png' class='img-responsive img-rounded' width='40%' height='40%' title='Eliminar Material'/></a></center>";
    } 

 ...
 */
$aColumns = array('idEvidencia', 'fecha', 'nombreActividad', 'nombreEvidencia', 'url_evidencia');
$sJoin = " INNER JOIN tbl_servicios ON tbl_servicios.idServicio = tbl_evidencias_actividades.idServicio ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idEvidencia";

/* DB table to use */
$sTable = "tbl_evidencias_actividades";

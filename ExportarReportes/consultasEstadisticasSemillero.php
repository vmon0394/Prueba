...
$sqlT = "SELECT * FROM `tbl_talleres` WHERE tipoTaller = 'Talleres Formativos' AND idSemillero = '$semillero' AND fechaTaller BETWEEN '2017-01-01' AND '2017-12-31'";
...
$sqlTP = "SELECT * FROM `tbl_talleres` WHERE tipoTaller = 'Taller Psicosocial' AND idSemillero = '$semillero' AND fechaTaller BETWEEN '2017-01-01' AND '2017-12-31'";
...
//Salidas pedagógicas
$sqlSP = "SELECT * FROM `tbl_talleres` WHERE tipoTaller = 'Salidas Pedagógicas' AND idSemillero = '$semillero' AND fechaTaller BETWEEN '2017-01-01' AND '2017-12-31'";

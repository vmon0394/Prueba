...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Registro de Habilidades</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <form  method="POST" class="form-horizontal" id="frmHabilidades">     
                            <div class="tab-pane">
                                <label class="alert alert-info">Los campos marcados con * son obligatorios </label>
                                <br> 
                                <input id="idHabilidad"  name="idHabilidad" type="hidden">
                                    ...
                                    <div class="controls">
                                        <div class="control-group">
                                            ...
                                            <div class="controls input-group">
                                                <input id="codigo"  name="codigo" type="text" placeholder="Ingrese el Código de la Habilidad" class="input-xlarge">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="textinput">Habilidad *</label>
                                            <div class="controls input-group">
                                                <input id="habilidad"  name="habilidad" type="text" placeholder="Ingrese el Nombre de la Habilidad" class="input-xxlarge">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                        ...
                                        <div class="tabbable tabs-left">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a href="#a" data-toggle="tab" class="">Habilidades</a></li>
                                                <li><a href="#b" data-toggle="tab" class="">Habilidades Eliminadas</a></li>
                                            </ul>
                                                        ...
                                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:550px">Habilidad</th>
                                                        ...
                                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol2">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:20px">N°</th> 
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:100px">Código</th>
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:670px">Habilidad</th>
        ...
        <script src="../js/funcionesHabilidades.js" type="text/javascript"></script>

            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <label class="alert alert-info">Los campos marcados con * son obligatorios. <br /></label>
                        <?php include_once '../Formularios/frmInstitucionlaboratorio.php'; ?>                       

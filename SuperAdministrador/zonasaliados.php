                    ...
                    <div class="tab-content"> 
                        ...
                        <center>
                            <div class="control-group">
                                    <a href="consultarsemilleros.php"><button type="button" class="btn btn-primary" data-dismiss="modal">Consultar Zonas</button></a>
                                    <a href="consultaraliados.php"><button type="button" class="btn btn-primary" data-dismiss="modal">Consultar Aliados</button></a>

                                        ...
                                        <div class="tab-pane active" id="a">
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    $sql = "SELECT COUNT(*) as contarsalidas FROM tbl_salidas WHERE isdelSalida = 1";
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    $sql = "SELECT SUM(numParticipantes) as contarparticisali FROM tbl_salidas WHERE isdelSalida = 1";
                                                    $rs = $conexion->query($sql);
                                                        if ($numero = $rs->fetch_assoc()){

 ...
 */
$aColumns = array('idCategoria', 'nombreCategoria', 'isdelCategoria');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idCategoria";

/* DB table to use */
$sTable = "tbl_categorias";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idCategoria") {
            $ID = $aRow[$aColumns[$i]];
            $row[] = "<center>" . $conta . "</center>";
        } else if ($aColumns[$i] == "isdelCategoria") {

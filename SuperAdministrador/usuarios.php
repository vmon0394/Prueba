                            ...
                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                ...
                                <div class="tabbable tabs-left">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#a" data-toggle="tab" class="">Usuarios</a></li>
                                        <li><a href="#b" data-toggle="tab" class="">Usuarios Eliminado</a></li>
                                    </ul>
                                                ...
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:100px">Nombres</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:100px">Apellidos</th>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:100px">Cierre Ingreso</th>
                                                ...
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol2">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:100px">Perfil</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:120px">Último Ingreso</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:60px">Consultar</th>

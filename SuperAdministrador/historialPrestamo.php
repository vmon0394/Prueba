...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Historial De Prestamos</h1>
                </div>
            </div>
            <br>
            <br>
                                        ...
                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:200px">Documento Usuario</th>
                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:200px">Codigo Articulo</th>
                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:200px">Fecha de Prestamo</th>
                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:200px">Fecha de Entrega</th>
                                                </tr>
                                            </thead>
                                            <tbody  id="index_ajax">
        ...
        <script src="../js/funcionesHistoriaPrestamoDevolucion.js" type="text/javascript"></script>

 ...
 */
$aColumns = array('idOrganizacion', 'nombreOrganizacion', 'contacto','cargo', 'telefono', 'isdelOrganizacion');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idOrganizacion";

/* DB table to use */
$sTable = "tbl_organizaciones";
...
$sWhere = " WHERE isdelOrganizacion = '1' ";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idOrganizacion") {
            $ID = $aRow[$aColumns[$i]];
            $row[] = "<center>" . $conta . "</center>";
        } else if ($aColumns[$i] == "isdelOrganizacion") {
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='30%' height='30%' title='Consultar Organizacion'/></a></center>";
    if ($estado == "1") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='delete' target='_blank'><img src='../img/dele.png' class='img-responsive img-rounded' width='40%' height='40%' title='Eliminar Organizacion'/></a></center>";
    }
//    else if ($estado == "0") {

            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        <label class="alert alert-info">Aca Podras consultar, cuántos semilleros se encuentran Registrados por Aliado</label>


                        <center>
                            <div class="control-group">
                            
                                 <a href="consultaraliados.php"><button type="button" class="btn btn-primary" data-dismiss="modal">Volver</button>  </a>
                            </div>
                        </center>  
                            <?php

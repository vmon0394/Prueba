...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='../$url_presupuesto' title='' data-toggle='modal' class='see' target='_blank'><img src='../img/download.png' class='img-responsive img-rounded' width='50%' height='50%' title='Descargar Documento'/></a></center>";
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='30%' height='30%' title='Consultar Documento'/></a></center>";

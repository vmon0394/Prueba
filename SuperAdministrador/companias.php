...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Compañias Relacionadas</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <?php include_once '../Formularios/frmCompanias.php'; ?>                       
                        ...
                        <div class="control-group">                                
                            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Listado de Compañias &nbsp;&nbsp;</button>
                            <!-- tabs left -->
                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                ...
                                <div class="tabbable tabs-left">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#a" data-toggle="tab" class="">Proyectos</a></li>
                                        <li><a href="#b" data-toggle="tab" class="">Compañias Eliminadas</a></li>
                                    </ul>
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    if (!$conexion) {
                                                        ...
                                                        $sql = "SELECT COUNT(*) as contarcompani FROM tbl_compania_relacionadas WHERE isdelCompania = 1";
                                                        $rs = $conexion->query($sql);
                                                            if ($numero = $rs->fetch_assoc()){
                                                                echo  "<h4>Proyectos Existentes: ".$numero['contarcompani']."</h4>";
                                                            }else{
                                                ...
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:650px">Compañia</th>
                                            ...
                                            <?php
                                                ...
                                                $conexion =$link->conectar();
                                                    ...
                                                    if (!$conexion) {
                                                        ...
                                                        $sql = "SELECT COUNT(*) as contarcompani FROM tbl_compania_relacionadas WHERE isdelCompania = 0";
                                                        $rs = $conexion->query($sql);
                                                            if ($numero = $rs->fetch_assoc()){
                                                                echo  "<h4>Compañias Eliminadas: ".$numero['contarcompani']."</h4>";
                                                            }else{
                                                                $this->result="Se Presento un Error";
                                                                }
                                                $link->desconectar();
                                            ...
                                            <div class="table-responsive">                            
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol2">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:20px">N°</th>                                        
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:770px">Compañia</th>
        ...
        <script src="../js/funcionesCompanias.js" type="text/javascript"></script>

 ...
 */
$aColumns = array('idFicha', 'documento', 'nombres', 'apellidos', 'nombreSemillero', 'isdel');
$sJoin = " INNER JOIN tbl_semilleros ON tbl_semilleros.idSemillero = tbl_ficha_sociofamiliar.idSemillero ";

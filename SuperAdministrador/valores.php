...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Registro Valores</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">    
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        <form  method="POST" class="form-horizontal" id="frmValores">     
                            <div class="tab-pane">
                                <label class="alert alert-info">Los campos marcados con * son obligatorios </label>
                                <br> 
                                <input id="idValor"  name="idValor" type="hidden">
                                    ...
                                    <div class="controls">
                                        <div class="control-group">
                                            ...
                                            <div class="controls input-group">
                                                <input id="valor"  name="valor" type="text" placeholder="Ingrese el Nombre del Valor" class="input-xlarge">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                        ...
                                        <div class="tabbable tabs-left">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a href="#a" data-toggle="tab" class="">Valores</a></li>
                                                <li><a href="#b" data-toggle="tab" class="">Valores Eliminadas</a></li>
                                            </ul>
                                                    ...
                                                    <br>
                                                     <?php
                                                        ...
                                                        $conexion =$link->conectar();
                                                            ...
                                                            $sql = "SELECT COUNT(*) as contarvalor FROM tbl_valores WHERE isdel_valor = 1";
                                                            $rs = $conexion->query($sql);
                                                                if ($numero = $rs->fetch_assoc()){
                                                                echo  "<h4>Valores Existentes: ".$numero['contarvalor']."</h4>";
                                                                }else{
                                                        ...
                                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:650px">Valor</th>
                                                    ...
                                                    <br>
                                                      <?php
                                                        ...
                                                        $conexion =$link->conectar();
                                                            ...
                                                            $sql = "SELECT COUNT(*) as contarvalor FROM tbl_valores WHERE isdel_valor = 0";
                                                            $rs = $conexion->query($sql);
                                                                if ($numero = $rs->fetch_assoc()){
                                                                echo  "<h4>Valores Eliminados: ".$numero['contarvalor']."</h4>";
                                                                }else{
                                                                $this->result="Se Presento un Error";
                                                                }
                                                        $link->desconectar();
                                                    ...
                                                    <div class="table-responsive">                            
                                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol2">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:20px">N°</th>                                        
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:770px">Valor</th>
        ...
        <script src="../js/funcionesValores.js" type="text/javascript"></script>

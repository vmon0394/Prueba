...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Registro Departamentos</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">    
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        <form  method="POST" class="form-horizontal" id="frmDepartamentos">     
                            <div class="tab-pane">
                                <label class="alert alert-info">Los campos marcados con * son obligatorios </label>
                                <br> 
                                <input id="idDepartamento"  name="idDepartamento" type="hidden">
                                    ...
                                    <div class="controls">
                                        <div class="control-group">
                                            ...
                                            <div class="controls input-group">
                                                <input id="departamento"  name="departamento" type="text" placeholder="Ingrese el Nombre del Departamento" class="input-xlarge">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                        ...
                                        <br>
                                         <?php
                                              ...
                                              $depar = new libDepartamentos();
                                              $depar->contarDepartamento();
                                              echo  $depar->getResult();
                                                ...
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:730px">Departamento</th>
        ...
        <script src="../js/funcionesDepartamentos.js" type="text/javascript"></script>

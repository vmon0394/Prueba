...
if ($tipo == '1') {
    ...
    $tipoBusqeda = "actividadCentral";
} else if ($tipo == '3') {
    $tipoBusqeda = "recomendaciones";
}else if ($tipo == '4') {
    $tipoBusqeda = "descripcionDeActividades";
}else if ($tipo == '5') {
    $tipoBusqeda = "observacion";
}
 ...
 */
$aColumns = array('idTaller', 'fechaTaller', $tipoBusqeda);
...
$sWhere = " WHERE idSemillero = '$idSemillero' AND  fechaTaller between '$fechaDesde' AND '$fechaHasta' ";

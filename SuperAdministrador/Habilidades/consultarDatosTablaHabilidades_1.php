 ...
 */
$aColumns = array('idHabilidades', 'codigoHabilidad', 'nombreHabilidad', 'isdelHabilidad');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idHabilidades";

/* DB table to use */
$sTable = "tbl_habilidades";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idHabilidades") {
            $ID = $aRow[$aColumns[$i]];
            $row[] = "<center>" . $conta . "</center>";
        } else if ($aColumns[$i] == "isdelHabilidad") {

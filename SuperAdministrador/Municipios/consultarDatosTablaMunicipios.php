 ...
 */
$aColumns = array('idMunicipio', 'departamento', 'municipio');
$sJoin = " INNER JOIN tbl_departamentos ON tbl_departamentos.idDepartamento = tbl_municipios.idDepartamento ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idMunicipio";

/* DB table to use */
$sTable = "tbl_municipios";
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='30%' height='30%' title='Consultar Municipio'/></a></center>";

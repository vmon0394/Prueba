                                            ...
                                            foreach ($servicio as $numero) {
                                                    echo" 
                                                        <tr>
                                                            ...
                                                            <td><center><a href='../SuperAdministrador/ModificarServicio.php?ui=".base64_encode($numero["idServicio"])."'><img src='../img/chulo.png' border= '0' height='20' width='30'/></a></center></td>

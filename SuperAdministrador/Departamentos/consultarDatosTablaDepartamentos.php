 ...
 */
$aColumns = array('idDepartamento', 'departamento');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idDepartamento";

/* DB table to use */
$sTable = "tbl_departamentos";
...
//    $row[] = $conta; //Nº
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='30%' height='30%' title='Consultar Departamento'/></a></center>";

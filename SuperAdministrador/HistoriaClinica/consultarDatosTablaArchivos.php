 ...
 */
$aColumns = array('idArchivo', 'fecha', 'observacion', 'url');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idArchivo";

/* DB table to use */
$sTable = "tbl_archivos_historia";
...
$sWhere = " WHERE idHistoria = '$idHistoria' ";

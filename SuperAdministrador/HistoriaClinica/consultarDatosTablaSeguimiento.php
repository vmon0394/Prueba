 ...
 */
$aColumns = array('idSeguimiento', 'fechaSeguimientoSesion', 'observaciones');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idSeguimiento";

/* DB table to use */
$sTable = "tbl_seguimiento_sesion";
...
$sWhere = " WHERE isdelSeguimiento = '1' AND idHistoria = '$idHistoria' ";

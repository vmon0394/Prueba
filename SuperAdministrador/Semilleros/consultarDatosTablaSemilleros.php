 ...
 */
$aColumns = array('idSemillero', 'nombreSemillero', 'nombreCategoria', 'nombresEmp', 'isdelSemillero');
$sJoin = " INNER JOIN tbl_categorias ON tbl_categorias.idCategoria = tbl_semilleros.idCategoria "
        . "INNER JOIN tbl_zonas ON tbl_zonas.idZona = tbl_semilleros.idZona "
        . "INNER JOIN tbl_personal_empleados ON tbl_personal_empleados.idEmpleado = tbl_semilleros.idProfesor";

...
<html>
    ...
    <body>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Registro Proyectos</h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">    
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        <form  method="POST" class="form-horizontal" id="frmProyectos">     
                            <div class="tab-pane">
                                <label class="alert alert-info">Los campos marcados con * son obligatorios </label>
                                <br> 
                                <input id="idProyecto"  name="idProyecto" type="hidden">
                                    ...
                                    <div class="controls">
                                        <div class="control-group">
                                            ...
                                            <div class="controls input-group">
                                                <input id="proyecto"  name="proyecto" type="text" placeholder="Ingrese el Nombre del Proyecto" class="input-xxlarge">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">                                
                                    <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Listado de Proyectos &nbsp;&nbsp;</button>
                                    <!-- tabs left -->
                                    <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                        ...
                                        <div class="tabbable tabs-left">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <li><a href="#b" data-toggle="tab" class="">Proyectos Eliminadas</a></li>
                                            </ul>
                                                        ...
                                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:650px">Proyecto</th>
                                                    ...
                                                    <div class="table-responsive">                            
                                                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol2">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:20px">N°</th>                                        
                                                                    <th class="text-center" style="padding-right: 10px; color: #000; width:770px">Proyecto</th>
        ...
        <script src="../js/funcionesProyectos.js" type="text/javascript"></script>

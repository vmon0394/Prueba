...
<div class="control-group">                                
    <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="">Listado de Atención y Consultoría &nbsp;&nbsp;</button>
    <!-- tabs left -->
                        ...
                        <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="padding-right: 10px; color: #000; width:80px">Beneficiario</th>
                                    <th class="text-center" style="padding-right: 10px; color: #000; width:80px">Proceso</th>
                                    <th class="text-center" style="padding-right: 10px; color: #000; width:200px">Psicólogo</th>
                                </tr>
                            </thead>
                            <tbody  id="index_ajax">

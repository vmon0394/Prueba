 ...
 */
$aColumns = array('idHistoFacilitador', 'nombresEmp', 'apellidosEmp', 'anoHisto');
$sJoin = " INNER JOIN tbl_personal_empleados ON tbl_personal_empleados.idEmpleado = tbl_historial_facilitador.idProfesor ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idHistoFacilitador";

/* DB table to use */
$sTable = "tbl_historial_facilitador";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idHistoFacilitador") {
            $ID = $aRow[$aColumns[$i]];

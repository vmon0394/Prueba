 ...
 */
$aColumns = array('idHistoHabilidad', 'codigoHabilidad', 'nombreHabilidad', 'anoHisto');
$sJoin = " INNER JOIN tbl_habilidades ON tbl_habilidades.idHabilidades = tbl_historial_habilidad.idHabilidad ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idHistoHabilidad";

/* DB table to use */
$sTable = "tbl_historial_habilidad";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idHistoHabilidad") {
            $ID = $aRow[$aColumns[$i]];

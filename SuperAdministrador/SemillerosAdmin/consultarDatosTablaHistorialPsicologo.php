 ...
 */
$aColumns = array('idHistoPsicologo', 'nombresEmp', 'apellidosEmp', 'anoHisto');
$sJoin = " INNER JOIN tbl_personal_empleados ON tbl_personal_empleados.idEmpleado = tbl_historial_psicologo.idPsicologo ";

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idHistoPsicologo";

/* DB table to use */
$sTable = "tbl_historial_psicologo";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idHistoPsicologo") {
            $ID = $aRow[$aColumns[$i]];

                                                ...
                                                <table class="table table-striped table-hover table-bordered table-condensed" id="tblRol1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:650px">tipo</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:650px">documento</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:650px">nombre</th>
                                                            <th class="text-center" style="padding-right: 10px; color: #000; width:650px">apellido</th>

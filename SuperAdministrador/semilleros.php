...
<html>
    ...
    <body>
        ...
        <script src="../js/funcionesFichasNinosSuperAdmin.js" type="text/javascript"></script>
        <script src="../js/funcionesFichasAdultosSuperAdmin.js" type="text/javascript"></script>

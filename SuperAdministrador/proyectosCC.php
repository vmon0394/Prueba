...
<html>
    ...
    <body> 
        ...
        <div class="container-fluid content-wrapper">
            ...
            <div class="row-fluid">
                <div class="logobar">
                    ...
                    <br>
                    <h1 align="center">Proyectos C.C. </h1>
                </div>
            </div>
            <br>
            <br>
            ...
            <div class="row-fluid">                
                <div class="breadcrumb">
                    <div class="tab-content"> 
                        ...
                        <?php include_once '../Formularios/frmProyectosCC.php'; ?>                       
                        ...
                        <div class="control-group">                                
                            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Listado de Intervenciones &nbsp;&nbsp;</button>
                            <!-- tabs left -->
                            <div id="demo" class="collapse in" style="border: solid 1px; font: normal 12px 'Arial','Verdana', 'serif', 'sans-serif', 'monospace' !important;">
                                ...
                                <div class="tabbable tabs-left">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#a" data-toggle="tab" class="">Intervenciones Existentes</a></li>
                                        <li><a href="#b" data-toggle="tab" class="">Intertvenciones Eliminadas</a></li>
                                    </ul>
                                        ...
                                        <div class="tab-pane active" id="a">
                                            ...
                                            <br>
                                             <?php
                                              ...
                                              $intervension = new libProyectosCC();
                                              $intervension->contarproyectos();
                                              echo  $intervension->getResult();
                                             ?>
                                            <br>
                                             <?php
                                              include_once '../Model/libProyectosCC.php';
                                              $participa = new libProyectosCC();
                                              $participa->contarparticipantes();
                                              echo  $participa->getResult();
                                             ?>
                                            <br>
                                            <br>
                                        ...
                                        <div class="tab-pane" id="b">
                                            ...
                                            <br>
                                             <?php
                                              include_once '../Model/libProyectosCC.php';
                                              $intervension = new libProyectosCC();
                                              $intervension->contarproyectoseli();
                                              echo  $intervension->getResult();
                                             ?>
                                              <br>
                                             <?php
                                              include_once '../Model/libProyectosCC.php';
                                              $participa = new libProyectosCC();
                                              $participa->contarparticipanteseli();
                                              echo  $participa->getResult();
                                             ?>
                                            <br>
                                            <br>
        ...
        <script src="../js/funcionesProyectosCC.js" type="text/javascript"></script>

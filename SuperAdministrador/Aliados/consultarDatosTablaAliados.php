 ...
 */
$aColumns = array('idAliado', 'nit', 'nombreAliados', 'contacto', 'isdelAliados');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "idAliado";
...
//    $row[] = $conta; //Nº
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        /* General output */
        if ($aColumns[$i] == "idAliado") {
            $ID = $aRow[$aColumns[$i]];
            $row[] = "<center>" . $conta . "</center>";
        } else if ($aColumns[$i] == "isdelAliados") {
    ...
    $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='consult' target='_blank'><img src='../img/consultar.png' class='img-responsive img-rounded' width='30%' height='30%' title='Consultar Aliado'/></a></center>";
    if ($estado == "1") {
        $row[] = "<center><a href='#' title='$ID' data-toggle='modal' class='delete' target='_blank'><img src='../img/dele.png' class='img-responsive img-rounded' width='40%' height='40%' title='Eliminar Aliado'/></a></center>";
    }
//    else if ($estado == "0") {
